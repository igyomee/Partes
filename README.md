...
- Cada tecnico se introduce con codigo, nombre completo autocompletado y DNI; el DNI/NIE debe coincidir con el registrado para ese codigo.
- Las horas de entrada y salida van en tramos de 30 minutos.
...
- Cada envio genera un `NºAlbarán` mensual con formato `MM-AA-NN`, por ejemplo `05-26-01`.
- `Linea ID` se calcula por fecha y tecnico: si un tecnico tiene dos partes el mismo dia, el segundo queda con `2`.
