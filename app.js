...
function validatePart(part) {
  ...
  if (invalidDniFormat) {
    ...
    return "El DNI/NIE de cada técnico debe tener una letra de control correcta.";
  }
  ...
  if (invalidDni) {
    ...
    row?.querySelector(".technician-dni").focus();
    return `El DNI/NIE de ${invalidDni.nombre} no corresponde con el registrado para el código ${invalidDni.codigo}.`;
  }
